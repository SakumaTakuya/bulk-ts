...
export const exerciseSchema = z.object({
  id: z.string().cuid().optional(), // Unique identifier for the exercise
  name: z.string().min(1), // Exercise name must be a non-empty string
});

export const workoutSetSchema = z.object({
  id: z.string().cuid().optional(), // Unique identifier for the set
...
export const workoutLogSchema = z.object({
  id: z.string().cuid().optional(), // Unique identifier for the workout log
