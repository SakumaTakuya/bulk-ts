...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/takuya.sakuma/src/example/workout-tracker-pwa/src/lib/prisma/client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/Users/takuya.sakuma/src/example/workout-tracker-pwa/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": "../../../../.env",
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "postgresql://neondb_owner:npg_N7yhAdcKmDo6@ep-little-leaf-a1859hrv-pooler.ap-southeast-1.aws.neon.tech/neondb?sslmode=require"
      }
    }
  },
  "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"../src/lib/prisma/client\" // Updated output path\n}\n\ndatasource db {\n  provider = \"postgresql\" // Neon uses the PostgreSQL protocol\n  url      = env(\"DATABASE_URL\")\n}\n\n// --- Authentication Models (NextAuth.js) ---\nmodel Account {\n  id                String  @id @default(cuid())\n  userId            String\n  type              String\n  provider          String\n  providerAccountId String\n  refresh_token     String? @db.Text\n  access_token      String? @db.Text\n  expires_at        Int?\n  token_type        String?\n  scope             String?\n  id_token          String? @db.Text\n  session_state     String?\n\n  user User @relation(fields: [userId], references: [id], onDelete: Cascade)\n\n  @@unique([provider, providerAccountId])\n}\n\nmodel Session {\n  id           String   @id @default(cuid())\n  sessionToken String   @unique\n  userId       String\n  expires      DateTime\n  user         User     @relation(fields: [userId], references: [id], onDelete: Cascade)\n}\n\nmodel User {\n  id            String    @id @default(cuid())\n  name          String?\n  email         String?   @unique\n  emailVerified DateTime?\n  image         String?\n  accounts      Account[]\n  sessions      Session[]\n\n  // App-specific relations\n  exercises   Exercise[]\n  workoutLogs WorkoutLog[]\n}\n\nmodel VerificationToken {\n  identifier String\n  token      String   @unique\n  expires    DateTime\n\n  @@unique([identifier, token])\n}\n\n// --- App-Specific Models ---\n\nmodel Exercise {\n  id   String @id @default(cuid())\n  name String @unique // Ensure exercise names are unique per user initially? Or globally? Let's start globally for simplicity.\n\n  userId String? // Optional: Track who created custom exercises\n  user   User?   @relation(fields: [userId], references: [id], onDelete: SetNull) // If user deleted, exercise remains\n\n  sets Set[] // Relation to sets using this exercise\n\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n}\n\nmodel WorkoutLog {\n  id   String   @id @default(cuid())\n  date DateTime // Date of the workout\n\n  userId String\n  user   User   @relation(fields: [userId], references: [id], onDelete: Cascade) // If user deleted, logs are deleted\n\n  sets Set[] // Relation to the sets performed in this log\n\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n\n  @@index([userId, date]) // Index for efficient querying by user and date\n}\n\nmodel Set {\n  id     String @id @default(cuid())\n  reps   Int\n  weight Float // Use Float for weight (e.g., 10.5 kg)\n\n  workoutLogId String\n  workoutLog   WorkoutLog @relation(fields: [workoutLogId], references: [id], onDelete: Cascade) // If log deleted, sets are deleted\n\n  exerciseId String\n  exercise   Exercise @relation(fields: [exerciseId], references: [id], onDelete: Cascade) // If exercise deleted, sets using it are deleted? Or restrict deletion? Let's cascade for now.\n\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n\n  @@index([workoutLogId])\n  @@index([exerciseId])\n}\n",
  "inlineSchemaHash": "d77224f49509e9393c09fcb964728ef20c64509ea98b0c3d3e48dcd56c737534",
  "copyEngine": true
}
